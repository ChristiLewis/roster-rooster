...
Roster.prototype.initializeRoster = function () {
    // this.engineers.push(new Engineer('ceo', 'budget'));
    // this.engineers.push(new Engineer('investor', 'schedule'));
    // this.engineers.push(new Engineer('client', 'revision'));

    this.currentEngineer = this.Engineer;
    ...
    Roster.prototype.startNewRoster = function () {
        if (this.manager.agility > this.currentEngineer.agility) {
