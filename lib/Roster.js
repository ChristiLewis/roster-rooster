    ...
    return inquirer.prompt([
        {
            ...
            validate: nameInput => {
                if (nameInput !== Rooster) {
                    console.log('You need to enter your Manager code name! Please see the README file for your code name.');
                } else {

                    Roster.prototype.startMenu = function () {
